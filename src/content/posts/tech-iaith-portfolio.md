...
|pajenn-br=61}}
```
![style example](../assets/style_example.png)
...
![training loss1](../assets/training-loss1.png)
Figure 1. The loss function over the training set.

![eval loss1](../assets/eval-loss1.png)
